...
class _ApiCatalogScreenState extends State<ApiCatalogScreen> {
  ...
  static const List<_ApiEntry> _entries = [
    ...
    _ApiEntry('GET', '/tai-khoan', 'Tài khoản', 'Danh sách và thống kê tài khoản'),
    _ApiEntry('PUT', '/tai-khoan/{username}', 'Tài khoản', 'Cập nhật vai trò'),
    _ApiEntry('DELETE', '/tai-khoan/{username}', 'Tài khoản', 'Vô hiệu hóa tài khoản'),
    _ApiEntry('POST', '/patients', 'Bệnh nhân', 'Tạo bệnh nhân'),
    _ApiEntry('GET', '/patients/{patientId}', 'Bệnh nhân', 'Chi tiết bệnh nhân'),
    _ApiEntry('PUT', '/patients/{patientId}', 'Bệnh nhân/Hồ sơ', 'Cập nhật bệnh nhân'),
    _ApiEntry('GET', '/patients/{patientId}/records', 'Hồ sơ lâm sàng', 'Danh sách bệnh án'),
    _ApiEntry('POST', '/patients/{patientId}/records', 'Hồ sơ lâm sàng', 'Tạo bệnh án'),
    _ApiEntry('GET', '/patients/{patientId}/examinations', 'Hồ sơ lâm sàng', 'Phiếu khám'),
    _ApiEntry('POST', '/patients/{patientId}/examinations', 'Hồ sơ lâm sàng', 'Tạo phiếu khám'),
    _ApiEntry('GET', '/patients/{patientId}/prescriptions', 'Hồ sơ lâm sàng', 'Đơn thuốc'),
    _ApiEntry('POST', '/patients/{patientId}/prescriptions', 'Hồ sơ lâm sàng', 'Tạo đơn thuốc'),
    _ApiEntry('GET', '/patients/{patientId}/documents', 'Hồ sơ lâm sàng', 'Tài liệu y tế'),
    _ApiEntry('POST', '/medical/upload-url', 'Hồ sơ lâm sàng', 'Tạo URL tải lên S3'),
    _ApiEntry('POST', '/medical/complete-upload', 'Hồ sơ lâm sàng', 'Xác nhận tải lên'),
    _ApiEntry('GET', '/medical/download-url', 'Hồ sơ lâm sàng', 'Tạo URL tải xuống'),
    ...
    _ApiEntry('GET', '/benhnhan/{patientId}', 'Bệnh nhân', 'Chi tiết tương thích'),
    _ApiEntry('GET', '/benhnhan/findByMaTK/{maTK}', 'Hồ sơ cá nhân', 'Ánh xạ tài khoản-bệnh nhân'),
    _ApiEntry('GET', '/bacsi', 'Bác sĩ', 'Danh sách bác sĩ'),
    _ApiEntry('GET', '/bacsi/maTK/{maTK}', 'Hồ sơ cá nhân', 'Ánh xạ tài khoản-bác sĩ'),
    _ApiEntry('GET', '/bacsi/tk/{maTK}', 'Hồ sơ cá nhân', 'Alias ánh xạ bác sĩ'),
    _ApiEntry('GET', '/nhansu', 'Nhân sự', 'Danh sách nhân sự'),
    _ApiEntry('GET', '/nhansu/maTK/{maTK}', 'Hồ sơ cá nhân', 'Ánh xạ tài khoản-nhân sự'),
    ...
    _ApiEntry('GET', '/lichkham/benhnhan/{patientId}', 'Lịch khám', 'Lịch của bệnh nhân'),
    _ApiEntry('GET', '/lichkham/bacsi/{doctorId}', 'Lịch khám', 'Lịch của bác sĩ'),
    _ApiEntry('GET', '/hsba', 'Hồ sơ lâm sàng', 'Danh sách bệnh án tương thích'),
    _ApiEntry('GET', '/hsba/benhnhan/{patientId}', 'Hồ sơ lâm sàng', 'Bệnh án theo bệnh nhân'),
    _ApiEntry('GET', '/phieukham', 'Hồ sơ lâm sàng', 'Danh sách phiếu khám'),
    _ApiEntry('GET', '/phieukham/nurse/queue', 'Hồ sơ lâm sàng', 'Hàng đợi điều dưỡng'),
    ...
    _ApiEntry('GET', '/lichlamviec/bacsi/{doctorId}', 'Lịch làm việc', 'Lịch bác sĩ'),
    _ApiEntry('GET', '/lichlamviec/nhansu/{staffId}', 'Lịch làm việc', 'Lịch nhân sự'),
    ...
    _ApiEntry('GET', '/phieuxetnghiem/{labResultId}', 'Xét nghiệm', 'Chi tiết kết quả'),
  ];
