...
class HospitalStack extends Stack {
  constructor(scope, id, props = {}) {
    ...
    /*
     * Read-only compatibility routes for the existing React frontend.
     * They expose the Week 1 DynamoDB sample data using the original
     * Vietnamese route names used by the UI.
     */
